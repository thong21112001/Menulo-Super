...
namespace Menulo.Infrastructure.Migrations
{
    ...
    [Migration("20251112065842_AddTbOrderHistory")]
    partial class AddTbOrderHistory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Menulo.Domain.Entities.OrderHistory", b =>
                {
                    ...
                    b.HasIndex("OrderId", "RoundNo")
                        .IsUnique()
                        .HasDatabaseName("UQ_OrderHistory_Order_Round");

                    b.ToTable("OrderHistorys", "dbo");
                });
            ...
            modelBuilder.Entity("Menulo.Domain.Entities.OrderItem", b =>
                {
                    ...
                    b.HasIndex("OrderId", "ItemId", "OrderHistoryId")
                        .IsUnique()
            ...
            modelBuilder.Entity("Menulo.Domain.Entities.OrderItem", b =>
                {
                    ...
                    b.HasOne("Menulo.Domain.Entities.OrderHistory", "OrderHistory")
                        .WithMany("OrderItems")
